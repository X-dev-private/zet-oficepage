...
// Dados manuais da equipe (movido para cima para evitar problemas de referência)
const teamMembers = [
  {
    id: 1,
    name: "Alex Carter",
    ...
    avatarUrl: "https://ui-avatars.com/api/?name=Alex+Carter&background=random",
  ...
  },
  {
    ...
    expertise: "React & UX",
    avatarUrl: "https://ui-avatars.com/api/?name=Sam+Lee&background=random",
...
// Componente TeamMemberCard com tipagem explícita
...
// Componente SocialLinks com tipagem
const SocialLinks = ({ member }: { member: typeof teamMembers[number] }) => (
